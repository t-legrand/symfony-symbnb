 ...
 * @UniqueEntity(
 *  fields={"email"},
 *  message="Un autre utilisateur existe déjà avec cette adresse email !"
 * )
 */
class User implements UserInterface
{
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\Length(min=10, minMessage="Votre description doit faire au moins {{ limit }} caractères")
     */

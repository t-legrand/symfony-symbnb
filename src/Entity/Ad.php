...
class Ad
{
     ...
     * @Assert\Length(min=10, max=255, minMessage="Le titre doit faire plus de {{ limit }} caractères", maxMessage="Le titre doit faire moins de {{ limit }} caractères")
     */
    private $title;
     ...
     * @Assert\Length(min=20, minMessage="Votre introduction doit faire au moins {{ limit }} caractères")
     */
    private $introduction;

    /**
     * @ORM\Column(type="text")
     * @Assert\Length(min=20, minMessage="Votre description doit faire au moins {{ limit }} caractères")
     */
    private $content;
    ...
    /**
     * Permet de récupérer le commentaire dun auteur par rapport à une annonce
     *
     * @param User $author
     * @return Comment|null
     */
